    ...
    <div class="menu" :style="{height:(myheight-60) + 'px'}">
      ...
      >
        <a-sub-menu key="person">
          <span slot="title"><a-icon type="mail" /><span>个人信息</span></span>
        ...
        <a-sub-menu key="TManager">
          <span slot="title"><a-icon type="appstore" /><span>台账管理</span></span>
        ...
        <a-sub-menu key="ZManager">
          <span slot="title"><a-icon type="setting" /><span>账号管理</span></span>
